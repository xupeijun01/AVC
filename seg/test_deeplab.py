# ----------------------------------------
# Adapted based on: https://github.com/YudeWang/semantic-segmentation-codebase/blob/main/experiment/seamv1-pseudovoc/test.py
#
...
from deeplab.utils.DenseCRF import dense_crf
from deeplab.utils.test_utils import single_gpu_test
from deeplab.utils.imutils import onehot
...
def test_net():
	...
	def collect_func(result_list, sample):
		...
		if cfg.TEST_CRF:
			...
			prob = dense_crf(prob, img_batched, n_classes=cfg.MODEL_NUM_CLASSES, n_iters=3)
